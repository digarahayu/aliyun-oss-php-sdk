...
/*
$keys2 = array(
	'public_key' => 'rsa1_public_key.pem',
	'private_key' => 'rsa1_private_key.pem'
);
...
$result = $ossEncryptionClient->putObject($bucket,'encry.txt',$content);
Common::println("encry.txt is created");


// download the object by rsa encrypt

$content = $ossEncryptionClient->getObject($bucket,'encry.txt');
Common::println("encry.txt is fetched, the content is: " . $content);
